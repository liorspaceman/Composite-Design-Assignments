...
d11 = d_matrix[0,0];
EPSx_top_max = max(EPSxys_top_set[max(EPSxys_top_set)])
delta = (d11*P*L**3)/(48*b);
#**********************************************************************************************************************************************************************************
# 5.1 Print Out Material Data
print("\n************************Results************************")
...
# 5.3 Print out Non-normailized Matrices [A] and [a]
...
print("\nThe maximum deflection from midplane is: ",delta," mm\n\nMaximum strain EPSx_max = ",str(EPSx_top_max)," mm/mm > 0.002.\nThe laminate meets criteria (1) but fails to meet (2)")    
